        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="user-insert">
                    ...
                    <div class="form-group">
                        <input id="quantity_to_insert" type="text" class="form-control form-control-user" placeholder="Quantity"/>
                    </div>
                    <div class="form-group">
                        <input id="unit_to_insert" type="text" class="form-control form-control-user" placeholder="Unit"/>
                    </div>
                    <hr />
            ...
            <div class="modal-body">
                <form class="update-user">
                    ...
                    <div class="form-group">
                        ...
                        <input id="quantity_to_update" type="text" class="form-control form-control-user" />
                    </div>
                    <div class="form-group">
                        <label>Unit </label>
                        <input id="unit_to_update" type="text" class="form-control form-control-user" />
                    </div>
                    <hr />
